    ...
    public function save(Request $request)
    {
        try {
            $validated = $request->validate([
                ...
                // Work Output Section - Numeric values between 1 and 10
                'work_planned_reporting' => 'nullable|numeric|min:1|max:10',
                'work_planned_reviewing' => 'nullable|numeric|min:1|max:10',
                'work_planned_initial' => 'nullable|numeric|min:1|max:10',
                'scientific_achievements_reporting' => 'nullable|numeric|min:1|max:10',
                'scientific_achievements_reviewing' => 'nullable|numeric|min:1|max:10',
                'scientific_achievements_initial' => 'nullable|numeric|min:1|max:10',
                'quality_output_reporting' => 'nullable|numeric|min:1|max:10',
                'quality_output_reviewing' => 'nullable|numeric|min:1|max:10',
                'quality_output_initial' => 'nullable|numeric|min:1|max:10',
                'analytical_ability_reporting' => 'nullable|numeric|min:1|max:10',
                'analytical_ability_reviewing' => 'nullable|numeric|min:1|max:10',
                'analytical_ability_initial' => 'nullable|numeric|min:1|max:10',
                'exceptional_work_reporting' => 'nullable|numeric|min:1|max:10',
                'exceptional_work_reviewing' => 'nullable|numeric|min:1|max:10',
                'exceptional_work_initial' => 'nullable|numeric|min:1|max:10',
                'overall_work_output_reporting' => 'nullable|numeric|min:1|max:10',
                'overall_work_output_reviewing' => 'nullable|numeric|min:1|max:10',
                'overall_work_output_initial' => 'nullable|numeric|min:1|max:10',
                
                // Personal Attributes Section - Numeric values between 1 and 10
                'attitude_work_reporting' => 'nullable|numeric|min:1|max:10',
                'attitude_work_reviewing' => 'nullable|numeric|min:1|max:10',
                'attitude_work_initial' => 'nullable|numeric|min:1|max:10',
                'sense_responsibility_reporting' => 'nullable|numeric|min:1|max:10',
                'sense_responsibility_reviewing' => 'nullable|numeric|min:1|max:10',
                'sense_responsibility_initial' => 'nullable|numeric|min:1|max:10',
                'maintenance_discipline_reporting' => 'nullable|numeric|min:1|max:10',
                'maintenance_discipline_reviewing' => 'nullable|numeric|min:1|max:10',
                'maintenance_discipline_initial' => 'nullable|numeric|min:1|max:10',
                'communication_skills_reporting' => 'nullable|numeric|min:1|max:10',
                'communication_skills_reviewing' => 'nullable|numeric|min:1|max:10',
                'communication_skills_initial' => 'nullable|numeric|min:1|max:10',
                'leadership_qualities_reporting' => 'nullable|numeric|min:1|max:10',
                'leadership_qualities_reviewing' => 'nullable|numeric|min:1|max:10',
                'leadership_qualities_initial' => 'nullable|numeric|min:1|max:10',
                'team_spirit_reporting' => 'nullable|numeric|min:1|max:10',
                'team_spirit_reviewing' => 'nullable|numeric|min:1|max:10',
                'team_spirit_initial' => 'nullable|numeric|min:1|max:10',
                'overall_personal_attributes_reporting' => 'nullable|numeric|min:1|max:10',
                'overall_personal_attributes_reviewing' => 'nullable|numeric|min:1|max:10',
                'overall_personal_attributes_initial' => 'nullable|numeric|min:1|max:10',
                
                // Functional Competency Section - Numeric values between 1 and 10
                'scientific_capability_reporting' => 'nullable|numeric|min:1|max:10',
                'scientific_capability_reviewing' => 'nullable|numeric|min:1|max:10',
                'scientific_capability_initial' => 'nullable|numeric|min:1|max:10',
                'st_foresight_reporting' => 'nullable|numeric|min:1|max:10',
                'st_foresight_reviewing' => 'nullable|numeric|min:1|max:10',
                'st_foresight_initial' => 'nullable|numeric|min:1|max:10',
                'decision_making_reporting' => 'nullable|numeric|min:1|max:10',
                'decision_making_reviewing' => 'nullable|numeric|min:1|max:10',
                'decision_making_initial' => 'nullable|numeric|min:1|max:10',
                'innovation_creativity_reporting' => 'nullable|numeric|min:1|max:10',
                'innovation_creativity_reviewing' => 'nullable|numeric|min:1|max:10',
                'innovation_creativity_initial' => 'nullable|numeric|min:1|max:10',
                'technical_competence_reporting' => 'nullable|numeric|min:1|max:10',
                'technical_competence_reviewing' => 'nullable|numeric|min:1|max:10',
                'technical_competence_initial' => 'nullable|numeric|min:1|max:10',
                'new_initiative_reporting' => 'nullable|numeric|min:1|max:10',
                'new_initiative_reviewing' => 'nullable|numeric|min:1|max:10',
                'new_initiative_initial' => 'nullable|numeric|min:1|max:10',
                'overall_functional_competency_reporting' => 'nullable|numeric|min:1|max:10',
                'overall_functional_competency_reviewing' => 'nullable|numeric|min:1|max:10',
                'overall_functional_competency_initial' => 'nullable|numeric|min:1|max:10',
            ]);
