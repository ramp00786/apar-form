...
<style>
    ...
    #page3 input:disabled, #page3 textarea:disabled {
...
<div class="bg-white/90 backdrop-blur-md shadow rounded mb-8 p-4 px-8" id="page3">
    ...
    <div class="flex justify-end py-4">
        ...
        <button id="saveBtn3" class="bg-green-500 text-white px-4 py-2 rounded mr-2" style="display: none;" onclick="saveChanges3()">
            {{-- save svg --}}
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline-block mr-1" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
        ...
        <button id="cancelBtn3" class="bg-gray-500 text-white px-4 py-2 rounded" style="display: none;" onclick="cancelEdit3()">
            {{-- cancel svg --}}
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline-block mr-1" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                        ...
                        <tbody>
                            <tr>
                                <td style="min-height: 360px; padding: 10px;">
                                    <textarea id="dutiesTextarea" disabled style="width: 100%; min-height: 330px; border: none; outline: none; resize: vertical;">{{ $duty->duties_description ?? '' }}</textarea>
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
@push('scripts')
    <script>
        ...
        function saveChanges3() {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    showToast3('Page 3 data saved successfully!');
                } else {
        ...
        function showToast3(message, type = 'success') {
