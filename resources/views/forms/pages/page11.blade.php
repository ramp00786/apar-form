...
<div class="bg-white/90 backdrop-blur-md shadow rounded mb-8 p-4 px-8" id="page11">
    ...
    @if ($isReportingOfficer)
        <div class="flex justify-end py-4">
            ...
            <button id="saveBtn11" class="bg-green-500 text-white px-4 py-2 rounded mr-2" style="display: none;"
                onclick="saveChanges11()">
            ...
            <button id="cancelBtn11" class="bg-gray-500 text-white px-4 py-2 rounded" style="display: none;"
                onclick="cancelEdit11()">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline-block mr-1" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
    ...
    @push('scripts')
        <script>
            ...
            function saveChanges11() {
                ...
                '#parameterTable11 tbody tr:not(:last-child)'); // Exclude total row
                const parameters = [];
                ...
                parameterRows.forEach((row, index) => {
                    ...
                    if (inputs.length >= 8) { // 1 param + 5 sub + 2 marks = 8 inputs
                        ...
                        if (parameterName || subParameterA || subParameterB || subParameterC || subParameterD ||
                            subParameterE || marksGiven || maxMarks) {
                            parameters.push({
